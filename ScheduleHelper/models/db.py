...
# a table for storing schedules
db.define_table('schedule',
    Field('user', 'reference auth_user'),
    Field('monday', 'list:integer'),
    Field('tuesday', 'list:integer'),
    Field('wednesday', 'list:integer'),
    Field('thursday', 'list:integer'),
    Field('friday', 'list:integer'),
    Field('saturday', 'list:integer'),
    Field('sunday', 'list:integer'))
